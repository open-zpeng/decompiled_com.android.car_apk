...
public final class WireFormat {
    ...
    public enum Utf8Validation {
        LOOSE { // from class: com.android.car.protobuf.WireFormat.Utf8Validation.1
            @Override // com.android.car.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream input) throws IOException {
                return input.readString();
            }
        },
        STRICT { // from class: com.android.car.protobuf.WireFormat.Utf8Validation.2
            @Override // com.android.car.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream input) throws IOException {
                return input.readStringRequireUtf8();
            }
        },
        LAZY { // from class: com.android.car.protobuf.WireFormat.Utf8Validation.3
            @Override // com.android.car.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream input) throws IOException {
    ...
    public enum FieldType {
        ...
        STRING(JavaType.STRING, 2) { // from class: com.android.car.protobuf.WireFormat.FieldType.1
            @Override // com.android.car.protobuf.WireFormat.FieldType
            public boolean isPackable() {
                return false;
            }
        },
        GROUP(JavaType.MESSAGE, 3) { // from class: com.android.car.protobuf.WireFormat.FieldType.2
            @Override // com.android.car.protobuf.WireFormat.FieldType
            public boolean isPackable() {
                return false;
            }
        },
        MESSAGE(JavaType.MESSAGE, 2) { // from class: com.android.car.protobuf.WireFormat.FieldType.3
            @Override // com.android.car.protobuf.WireFormat.FieldType
            public boolean isPackable() {
                return false;
            }
        },
        BYTES(JavaType.BYTE_STRING, 2) { // from class: com.android.car.protobuf.WireFormat.FieldType.4
            @Override // com.android.car.protobuf.WireFormat.FieldType
            public boolean isPackable() {
                return false;
            }
